...
const copy = {
  en: {
    ...
    coachEyebrow: "Meet your coach", coachName: "Alvaro Valdes", coachTitle: "Built for real life. Coached for real results.",
  ...
  es: {
    ...
    coachEyebrow: "Conoce a tu coach", coachName: "Alvaro Valdes", coachTitle: "Creado para la vida real. Entrenado para resultados reales.",
